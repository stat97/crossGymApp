...
export const CheckCode = () => {
  ...
  if (okCheck) {
    ...
    if (!localStorage.getItem('user')) {
      ...
      return <Navigate to="/FormProfile" />;
    }
          ...
          <form onSubmit={handleSubmit(formSubmit)}>
            ...
            <div>
              <p className="bottom_text">
                Si el código introducido no es correcto el usuario se eliminará automáticamente por motivos de seguridad.Tendrá que volver a repetir el registro.
              </p>
            </div>
          </form>
        </div>
